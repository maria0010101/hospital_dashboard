...
- **v0.4**：圖表 X 軸改為純民國年月並依寬度自動疏密不重疊，放大檢視支援 X 軸視窗縮放（縮放愈大顯示愈多月標籤）；其他分頁收入趨勢改折線呈現、新增各院區總/自費收入累計千元橫條（相連＋段內數值）與各類點擊明細（各院區＋近三個月＋去年同期）；科別門診人次 TOP20 改單條並於色塊起始顯示千人數值、條尾附平均每診人次；病床分頁篩選改大類別、新增「僅最新年月／累計」切換（開關移至開床數趨勢下方）、登記 vs 實際開床數改重疊橫條（每列院區＋開床率）、移除護理站維度分析；佔床率明細預設僅顯示最新年月（床數為單月）；各分頁點擊帶各院區明細卡
